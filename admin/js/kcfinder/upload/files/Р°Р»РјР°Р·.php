...
$num = 5; // Çäåñü óêàçûâàåì ñêîëüêî õîòèì âûâîäèòü òîâàðîâ.
  ...
  $qury_start_num = " LIMIT $start, $num"; 
	 				...
	 				// $i = 1;
	 				$result = mysql_query("SELECT * FROM Проекти WHERE Фрази LIKE '%алмаз%' $qury_start_num",$link);  
	 				if (mysql_num_rows($result) > 0)
					{
 					...
 					do
 					{
 						echo 
 						'
 							<a class="asp" href="../../view_project.php?Заголовок='.$row["Заголовок"].'">'.$row["Заголовок"].'</a><br>
 						';
 						echo $row["Анотація"];
 					}
