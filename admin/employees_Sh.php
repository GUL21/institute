		...
		<table id="table">
 			...
 			<tbody>
 				<ul class="letter">
 							...
 							<li><a href="employees_Sh.php" class="red">Ш</a></li>
 							<li><a href="employees_Shch.php">Щ</a></li>
 							<li><a href="employees_Yu.php">Ю</a></li>
 							<li><a href="employees_Ya.php">Я</a></li>		
 				</ul>
		<?php
			$result = mysql_query("SELECT * FROM employees, categories WHERE PIB LIKE 'Ш%' AND employees.section=categories.name AND employees.visible='1'",$link);  
