...
<body>
	...
	<div id="block-content">
		...
		<table id="table">
 			...
 			<tbody>
 				<ul class="letter">
 							...
 							<li><a href="employees_I.php" class="red">І</a></li>
		...
		<?php
			$result = mysql_query("SELECT * FROM employees, categories WHERE PIB LIKE 'І%' AND employees.section=categories.name AND employees.visible='1'",$link);  
