...
<body>
	...
	<div id="block-content">
		...
		<table id="table">
 			...
 			<tbody>
 				<ul class="letter">
 							...
 							<li><a href="employees_N.php" class="red">Н</a></li>
		...
		<?php
			$result = mysql_query("SELECT * FROM employees, categories WHERE PIB LIKE 'Н%' AND employees.section=categories.name AND employees.visible='1'",$link);  
