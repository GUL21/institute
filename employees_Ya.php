		...
		<table id="table">
 			...
 			<tbody>
 				<ul class="letter">
 							...
 							<li><a href="employees_Ya.php" class="red">Я</a></li>		
 				</ul>
		<?php
			$result = mysql_query("SELECT * FROM employees, categories WHERE PIB LIKE 'Я%' AND employees.section=categories.name AND employees.visible='1'",$link);  
