...
<body>
	...
	<div id="block-content">
		...
		<table id="table">
 			...
 			<tbody>
 				<ul class="letter">
 							...
 							<li><a href="employees_D.php" class="red">Д</a></li>
		...
		<?php
			$result = mysql_query("SELECT * FROM employees, categories WHERE PIB LIKE 'Д%' AND employees.section=categories.name AND employees.visible='1'",$link);  
